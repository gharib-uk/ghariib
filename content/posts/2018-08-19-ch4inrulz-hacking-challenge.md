...
date: Sun, 19 Aug 2018 07:52:29 +0000
draft: false
type: posts
---
...
Out of all these API PHP scripts, only files\_api.php seemed to exist:
...
You may be wondering why I’m not just using screenshots of the browser. The truth is I’m lazy. Alright, so file\_api.php expects a parameter file that points to a file on the local filesystem. So this screamed local file inclusion. Giving it a go was a fail though:
